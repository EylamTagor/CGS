...
public class PsychoSearch extends PApplet {
	...
	public PsychoSearch(ArrayList<String> as, String question, int seconds, Player p, int conf, ArrayList<Question> answer, ArrayList<Question> wronganswers, int index) {
		slide = 0;
		bool = false;
	...
	public PsychoSearch(Question ques, int seconds, Player p, int conf, ArrayList<Question> answer, ArrayList<Question> wronganswers, int index) {
		player = p;
		bool = false;
