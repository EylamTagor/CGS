...
//		System.out.println(Arrays.toString(player.getProgress()));
	...
	public void drawPsychoSearchNatsGame(int inde) {
		...
		active = new PsychoSearch(wronganswers.get(inde), seconds, player, 5, filler1, filler2,
				rightAnswers, 2, this);
	...
	public void drawBirdBlunderNatsGame(int inde) {
		...
		active = new BirdBlunder(wronganswers.get(inde), birdspersec, 5, player, filler1, filler2,
				rightAnswers, inde, this);
		active.setup();
	...
	public void drawBirdBlunderGame() {
		...
		active = new BirdBlunder(as.get(0), birdspersec, spaceConfIndicator, player, as, wronganswers,
				rightAnswers, 3, this);
	...
	public void drawPsychoSearchGame() {
		...
		active= new PsychoSearch(as.get(3), seconds, player, spaceConfIndicator, as, wronganswers,
				rightAnswers, 2, this);
		active.setup();
