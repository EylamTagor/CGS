...
public class PhysicsShape {
	...
	private TwoDShapes s;   // If your library has 2 levels of inheritance, could change this to be 1 level down (A 2D Shape rather than a Shape)
	private float vx, vy;
	...
	public void draw(PApplet drawer, Rectangle window) {   // -------STEP 2-------   (after this, see if your shape is visible)
	...
	public boolean overlaps (Rectangle r) {
		...
		if(this.s instanceof Rectangle) {
		    return s.getX() < r.getX() + r.getWidth() && s.getX() + s.getWidth() > r.getX() && s.getY() < r.getY() + r.getHeight() && s.getY() + s.getHeight() > r.getY();
